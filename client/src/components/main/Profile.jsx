...
const Profile = () => {
  ...
  const renderContent = () => {
    switch (selectedOption) {
      ...
      case 'Experiences':
        ...
        <div className='flex items-center justify-between pl-5 pt-2 mt-5 mb-5'>
            <div className='flex gap-5'>
                <img style={{height:"5rem",width:"5rem",borderRadius:"2.5rem"}} src='./static/images/default.jpeg'></img>
                <div>
                    <p className='pb-1' style={{fontWeight:"600",fontSize:"1.35rem"}}>Sr. Product Designer</p>
        ...
        <div className='flex items-center justify-between pl-5 pt-2 mt-5 mb-5'>
            <div className='flex gap-5'>
                <img style={{height:"5rem",width:"5rem",borderRadius:"2.5rem"}} src='./static/images/default.jpeg'></img>
                <div>
                    <p className='pb-1' style={{fontWeight:"600",fontSize:"1.35rem"}}>Product Designer</p>
      ...
      case 'Education':
        return <div>        <div className='bg-white rounded-xl mt-5 p-5'>
        <div className='flex items-center justify-between pl-5 pt-2 mt-5 mb-5'>
            <div className='flex gap-5'>
                <img style={{height:"5rem",width:"5rem",borderRadius:"2.5rem"}} src='./static/images/default.jpeg'></img>
                <div>
        ...
        <div className='flex items-center justify-between pl-5 pt-2 mt-5 mb-5'>
            <div className='flex gap-5'>
                <img style={{height:"5rem",width:"5rem",borderRadius:"2.5rem"}} src='./static/images/default.jpeg'></img>
                <div>
                    <p className='pb-1' style={{fontWeight:"600",fontSize:"1.35rem"}}>California Institute of the Arts</p>
        ...
        <div className='flex items-center justify-between pl-5 pt-2 mt-5 mb-5'>
            <div className='flex gap-5'>
                <img style={{height:"5rem",width:"5rem",borderRadius:"2.5rem"}} src='./static/images/default.jpeg'></img>
                <div>
                    <p className='pb-1' style={{fontWeight:"600",fontSize:"1.35rem"}}>University of Pennsylvania</p>
